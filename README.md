...
The document [Oximeter overview](Oximeter_overview.pdf) aims to provide an overview of the technical aspects of our sensor.

## Features

- Measures the percentage of dissolved oxygen within a range of 0 to 105 %.
